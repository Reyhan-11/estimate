        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Estimate</h5>
                </div>
                <div class="card-body">
                            ...
                            <div>
                                @foreach ($item_ids as $index  => $item_id)
                                    <div class="row mb-2 align-items-center">
                                        <div class="col-lg-4">
                                            <select wire:model="item_ids.{{ $index  }}" 
                                                    class="form-select @error('item_ids.' . $index) is-invalid @enderror">
                                        ...
                                        <div class="col-lg-6" wire:ignore>
                                            <textarea id="description-{{ $index }}" class="form-control description-editor"
            ...
            if (!editorElement.classList.contains('ckeditor-initialized')) {
                ClassicEditor
                    .create(editorElement, {
                        ckfinder: {
                            uploadUrl: "{{ route('ckeditor.upload.edit.estimate') }}?_token={{ csrf_token() }}",
                        }
                    })
                    .then(editor => {
