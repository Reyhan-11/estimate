<!DOCTYPE html>
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('sneat-template/assets/') }}" data-template="vertical-menu-template-free">

<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>UGS-ESTIMATE | {{ $title ?? ucwords(str_replace("-"," ",request()->path())) }}</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('sneat-template/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
...
<style>
    body {
        background-image: url('logo/KomatsuGrey.jpg');
